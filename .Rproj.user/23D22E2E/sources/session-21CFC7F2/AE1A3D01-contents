#First creating APH distance file
#Now load in new data by file
H3K36me3_distance_file = "C:/R_scripts_feng/tp/Data/true_DSB_APH/distance_features/H3K36me3_NMAPH_closest.bed"
H3K27me3_distance_file =  "C:/R_scripts_feng/tp/Data/true_DSB_APH/distance_features/H3K27me3_NMAPH_closest.bed"
H3K4me3_distance_file = "C:/R_scripts_feng/tp/Data/true_DSB_APH/distance_features/H3K4me3_NMAPH_closest.bed"
DNaseIHSS1_distance_file = "C:/R_scripts_feng/tp/Data/true_DSB_APH/distance_features/DNaseIHSS1_NMAPH_closest.bed"
DNaseIHSS2_distance_file = "C:/R_scripts_feng/tp/Data/true_DSB_APH/distance_features/DNaseIHSS2_NMAPH_closest.bed"
CTCF_distance_file = "C:/R_scripts_feng/tp/Data/true_DSB_APH/distance_features/CTCF_NMAPH_closest.bed"
Origin_distance_file = "C:/R_scripts_feng/tp/Data/true_DSB_APH/distance_features/Origin_NMAPH_closest.bed"
...
write.table(df1,file=paste0("C:/R_scripts_feng/tp/Data/true_DSB_APH/APH_DSB_distance_features_with_bed.txt"),row.names=F,sep='\t',quote=F)


#Ok, now need to create non_APH_distance_features
...
#create df
df1 <- df1[,c("Chr", "Start", "End","Distance_to_Origin","Distance_to_CTCF","Distance_to_DNaseIHSS1","Distance_to_DNaseIHSS2","Distance_to_H3K4me3","Distance_to_H3K27me3","Distance_to_H3K36me3")]
write.table(df1,file=paste0("C:/R_scripts_feng/tp/Data/Random_Sample_APH/Non_APH_DSB_distance_features_with_bed.txt"),row.names=F,sep='\t',quote=F)

# Finally, append these two files
Non_APH_DSB_distance_features <- read.csv("C:/R_scripts_feng/tp/Data/Random_Sample_APH/Non_APH_DSB_distance_features_with_bed.txt", sep="\t", header=1)
True_APH_DSB_distance_features <- read.csv("C:/R_scripts_feng/tp/Data/true_DSB_APH/APH_DSB_distance_features_with_bed.txt", sep="\t", header=1)

full_distance_APH <- rbind(Non_APH_DSB_distance_features, True_APH_DSB_distance_features)
write.table(full_distance_APH,file=paste0("C:/R_scripts_feng/tp/Data/Stuff_to_send_Feng/distance_APH_shuffled.txt"),row.names=F,sep='\t',quote=F)
