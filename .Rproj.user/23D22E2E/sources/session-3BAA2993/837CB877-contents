...
#write.table(X_train, file=paste0("C:/R_scripts_feng/tp/Data/Neural_Net_nonAPH_APH/X_train.txt"), row.names=F, sep='\t', quote=F)
#write.table(Y_train, file=paste0("C:/R_scripts_feng/tp/Data/Neural_Net_nonAPH_APH/Y_train.txt"), row.names=F, sep='\t', quote=F)
#write.table(X_test, file=paste0("C:/R_scripts_feng/tp/Data/Neural_Net_nonAPH_APH/X_test.txt"), row.names=F, sep='\t', quote=F)
#write.table(Y_test, file=paste0("C:/R_scripts_feng/tp/Data/Neural_Net_nonAPH_APH/Y_test.txt"), row.names=F, sep='\t', quote=F)
...
# Variable Importance 
varImpPlot(rf, main="APH Variable Importance Plot")
