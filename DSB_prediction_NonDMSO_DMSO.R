...
#write.table(X_train, file=paste0("C:/R_scripts_feng/tp/Data/Neural_Net_nonDMSO_DMSO/X_train.txt"), row.names=F, sep='\t', quote=F)
#write.table(Y_train, file=paste0("C:/R_scripts_feng/tp/Data/Neural_Net_nonDMSO_DMSO/Y_train.txt"), row.names=F, sep='\t', quote=F)
#write.table(X_test, file=paste0("C:/R_scripts_feng/tp/Data/Neural_Net_nonDMSO_DMSO/X_test.txt"), row.names=F, sep='\t', quote=F)
#write.table(Y_test, file=paste0("C:/R_scripts_feng/tp/Data/Neural_Net_nonDMSO_DMSO/Y_test.txt"), row.names=F, sep='\t', quote=F)
...
# Variable Importance 
varImpPlot(rf, main="DMSO Variable Importance Plot")
...
dataDSB = dataDSB[-which(dataDSB$DSBType==1),] # for nonDMSO
library(sjPlot)
tab_corr(dataDSB[,-c(1)],
         title="Correlations Between Variables for Shuffled DMSO DSB Regions",
         corr.method = "pearson",
